                                ...
                                t.DatasetController.extend({
                                    ...
                                    updateElement: function (t, a, i) {
                                        ...
                                        var v = l.startAngle,
                                            x = t.hidden
                                                ? 0
                                                : d.getDistanceFromCenterForValue(
                                                      r.data[a]
                                                  ),
                                            y = v + h * p,
                                            k = y + (t.hidden ? 0 : h),
                            ...
                            e.extend(t.Controller.prototype, {
                                ...
                                update: function (a, i) {
                                    ...
                                    e.each(
                                        ...
                                        t.plugins.notify("afterScaleUpdate", [
                                            n,
                                        ]),
                                        e.each(o, function (t) {
                                            t.reset();
                                ...
                                draw: function (a) {
                                    ...
                                    i.clear(),
                                        ...
                                        t.plugins.notify("beforeDatasetsDraw", [
                                            i,
                                            n,
                                        ]),
                                        e.each(
                                        ...
                                        t.plugins.notify("afterDatasetsDraw", [
                                            i,
                                            n,
                                        ]),
                                ...
                                destroy: function () {
                                    ...
                                    (i.width = a.chart.width),
                                        ...
                                        (i.style.width =
                                            a.chart.originalCanvasStyleWidth),
                                        (i.style.height =
                                            a.chart.originalCanvasStyleHeight),
                        ...
                        (t.DatasetController = function (t, e) {
                            ...
                            e.extend(t.DatasetController.prototype, {
                                ...
                                addElementAndReset: function (t) {
                                    ...
                                    e.getMeta().data.splice(t, 0, a),
                                        e.updateElement(a, t, !0);
                                },
                    ...
                    e.exports = function () {
                        var t = function (e, a) {
                            ...
                            return (
                                ...
                                (i.ctx = e),
                                (i.canvas = e.canvas),
                                (e.canvas.style.display =
                                    e.canvas.style.display || "block"),
                                (i.width =
                                    e.canvas.width ||
                                    parseInt(
                                        n.getStyle(e.canvas, "width"),
                                        10
                                    ) ||
                                ...
                                (i.height =
                                    e.canvas.height ||
                                    parseInt(
                                        n.getStyle(e.canvas, "height"),
                                        10
                                    ) ||
                                    n.getMaximumHeight(e.canvas)),
                                (i.aspectRatio = i.width / i.height),
                                (isNaN(i.aspectRatio) ||
                                    isFinite(i.aspectRatio) === !1) &&
                                    (i.aspectRatio =
                                        void 0 !== a.aspectRatio
                                            ? a.aspectRatio
                                            : 2),
                                (i.originalCanvasStyleWidth =
                                    e.canvas.style.width),
                                (i.originalCanvasStyleHeight =
                        ...
                        (t.defaults.global.legend = {
                            ...
                            (t.Legend = t.Element.extend({
                                ...
                                buildLabels: function () {
                                    var t = this;
                                    (t.legendItems =
                                        t.options.labels.generateLabels.call(
                                            t,
                                            t.chart
                                        )),
                                        t.options.reverse &&
                                            t.legendItems.reverse();
                                },
                                afterBuildLabels: a,
                                beforeFit: a,
                                fit: function () {
                    ...
                    e.exports = function (t) {
                        ...
                        (t.defaults.scale = {
                            ...
                            (t.Scale = t.Element.extend({
                                ...
                                beforeFit: function () {
                                    e.callCallback(this.options.beforeFit, [
                                        this,
                                    ]);
                                },
                                fit: function () {
                                    ...
                                    a.margins &&
                                        ...
                                        (a.paddingTop = Math.max(
                                            a.paddingTop - a.margins.top,
                                            0
                                        )),
                                        (a.paddingRight = Math.max(
                                            a.paddingRight - a.margins.right,
                                ...
                                afterFit: function () {
                                    e.callCallback(this.options.afterFit, [
                                        this,
                                    ]);
                                },
                                isHorizontal: function () {
                                ...
                                update: function (t) {
                                    ...
                                    if (d.length) {
                                        ...
                                        r.determineAlignment(p),
                                            n.extend(
                                                s,
                                                r.getBackgroundPoint(s, p)
                                            );
                                    } else r._model.opacity = 0;
                                    return (
                                        t && l.custom && l.custom.call(r, s), r
                                    );
                                },
                            ...
                            var e = t.helpers,
                                ...
                                o = t.Scale.extend({
                                    ...
                                    getLabelForIndex: function (t, e) {
                                        ...
                                        return (
                                            "object" ==
                                                typeof a.chart.data.datasets[e]
                                                    .data[0] &&
                                                (i = a.getRightValue(
                                                    a.chart.data.datasets[e]
                                                        .data[t]
                                                )),
                                    ...
                                    parseTime: function (t) {
                                        ...
                                        return "string" ==
                                            ...
                                            ? (console.warn(
                                                  "options.time.format%20is%20deprecated%20and%20replaced%20by%20options.time.parser.%20See%20http_/nnnick.github.io/Chart.js/docs-v2/index.html#scales-time-scale"
                                              ),
