            ...
            function (a, b) {
                ...
                var k,
                    ...
                    T = (function () {
                        ...
                        return (
                            ...
                            (o =
                                ...
                                Number(
                                    S.substr(
                                        S.indexOf("Version/index.html") + 8,
                                        1
                                    )
                                ) < 6),
                    ...
                    aa = (R.calculateOffset = function (a, b, c) {
                        ...
                        return (
                            a["offset" + d] -
                            (_(a, b, parseFloat(e), e.replace(w, "")) || 0)
                        );
                    }),
                    ba = function (a, b) {
                        var c,
                    ...
                    fa = function (a, b, c) {
                        ...
                        for (c = c || Z(a, null); --f > -1; )
                            (d -=
                                parseFloat($(a, "padding" + e[f], c, !0)) || 0),
                                (d -=
                                    parseFloat(
                                        $(a, "border" + e[f] + "Width", c, !0)
                                    ) || 0);
                        return d;
                    },
                    ga = function (a, b) {
                ...
                (j = g.prototype),
                    ...
                    (j._enableTransforms = function (a) {
                        (this._transform =
                            this._transform || Pa(this._target, e, !0)),
                            (this._transformType =
                                (this._transform.svg && za) ||
        ...
        if (!d.TweenLite) {
            ...
            var F = s(
                    ...
                    function (b, c, d) {
                        ...
                        this.target = b =
                            "string" != typeof b ? b : F.selector(b) || b;
                        var e,
                            f,
                            g,
                            h =
                ...
                M = function (a, b, c, d) {
                    ...
                    for (
                        ...
                        (k = f[h]),
                            ...
                            (m += k.length);
                    return (
                        (n += b.substr(m)), n && l.push(n), (l.setRatio = L), l
                    );
                },
                ...
                (C._updateRoot = F.render =
                    function () {
                        ...
                        if (
                            (I.length && X(),
                            V.render(
                                (h.time - V._startTime) * V._timeScale,
                                !1,
                                !1
                            ),
                            U.render(
            ...
            (g._init = function () {
                ...
                (F.killTweensOf = F.killDelayedCallsTo =
                    function (a, b, c) {
                        ...
                        for (
                            var d = F.getTweensOf(a, b), e = d.length;
                            --e > -1;
            ...
            if (
                ...
                for (g in p)
                    p[g].func ||
                        a.console.log(
                            "GSAP encountered missing dependency: " + g
                        );
            }
            i = !1;
        }
...
!(function (a, b) {
    ...
    window.SplitType = (function (a, b, c) {
        ...
        function t(a) {
            return (
                r(a) && "[object Object]" === Object.prototype.toString.call(a)
            );
        }
        function u(a) {
        ...
        function C(b) {
            ...
            if (
                ((x = j ? A("div") : o()),
                (n.innerHTML = b.innerHTML.replace(
                    /<br\s*\/?>/g,
                    " " + e + " "
                )),
                ...
                (D.prototype.split = function (b) {
                    this.revert(),
                        ...
                        w(this.elements, function (a) {
                            for (
                                var b = y(a).nodes || [], c = 0, d = b.length;
                                c < d;
                                c++
                            )
                                z(b[c]);
